...
def init_db():
    ...
    if jobs_count == 0:
        sample_jobs = [
            ...
            ("Full Stack Developer", "DevSolutions", "Mumbai", "Full-time", "3-5 years",
             "₹12-18 LPA", "React, Node.js, MongoDB, Express",
             "Full stack development with MERN stack",
             "Experience with both frontend and backend", "Active"),
            ("Data Analyst", "DataCorp", "Delhi", "Full-time", "1-3 years",
             "₹7-11 LPA", "Python, SQL, Excel, Power BI",
             "Data analysis and visualization",
             "Strong analytical skills, experience with BI tools", "Active"),
            ("DevOps Engineer", "CloudTech", "Pune", "Full-time", "2-4 years",
             "₹10-15 LPA", "AWS, Docker, Kubernetes, Jenkins",
             "DevOps and cloud infrastructure management",
             "Experience with CI/CD pipelines and cloud platforms", "Active"),
        ]
